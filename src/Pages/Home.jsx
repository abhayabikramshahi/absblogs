...
function HomePage() {
  ...
  const seoData = useSEO({
    title: 'News Portal - Latest Breaking News and Updates',
    description: 'Stay informed with the latest breaking news, in-depth reporting, and comprehensive coverage from around Nepal and the world.',
    keywords: 'nepal news, breaking news, latest updates, cyber security, technology news, world news',
    type: 'website',
